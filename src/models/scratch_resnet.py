...
class ResNetScratch(nn.Module):
    ...
    def _make_layer(self, out_channels: int, blocks: int, stride: int = 1) -> nn.Module:
        downsample = None
...
def resnet18_scratch(num_classes: int) -> ResNetScratch:
    return ResNetScratch(layers=[2, 2, 2, 2], num_classes=num_classes)
